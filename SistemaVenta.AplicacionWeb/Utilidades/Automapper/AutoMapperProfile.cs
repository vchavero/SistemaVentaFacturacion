    ...
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile()
        {
           ...
           .ForMember(destino =>
            ...
            #region FormaPago
            CreateMap<FormaPago, VMFormaPago>().ReverseMap();
            #endregion
            ...
            #region Uso CFDI
            CreateMap<UsoCFDI, VMUsoCFDI>().ReverseMap();
            #endregion
            ...
            CreateMap<VMVenta, VMDetallesFacturaVenta>().ReverseMap();
            CreateMap<DetallesFacturaVenta, VMDetallesFacturaVenta>().ReverseMap();
            CreateMap<DetallesFacturaVenta, Venta>().ReverseMap();
            #endregion
