...
namespace SistemaVenta.DAL.DBContext
{
    public partial class DBVENTAContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.cveFormaPago)
                    .HasName("PK__FormaPago__FF2230E11116A1B2");

                entity.Property(e => e.cveFormaPago).HasColumnName("cveFormaPago");
            ...
            modelBuilder.Entity<Cliente>(entity =>
            {
                ...
                //entity.Property(e => e.Regimen).HasColumnName("cveRegimen");
                entity.Property(e => e.cveRegimen).HasColumnName("cveRegimen");

                entity.HasOne(d => d.Regimen)
                    .WithMany(p => p.Clientes)
                    .HasForeignKey(d => d.cveRegimen)
                    .HasConstraintName("FK_Cliente_RegimenFiscal");

            });

            modelBuilder.Entity<RegimenFiscal>(entity =>
            {
                entity.HasKey(e => e.cveRegimen)
            ...
            {
                entity.HasKey(e => e.claveUsoCFDI)
                    .HasName("PK_UsoCfdi");

                entity.Property(e => e.claveUsoCFDI).HasColumnName("cveUsoCfdi");
            ...
            modelBuilder.Entity<Venta>(entity =>
            {
                ...
                entity.Property(e => e.IdCliente).HasColumnName("idCliente");
                entity.Property(e => e.CveFormaPago).HasColumnName("cveFormaPago");
                entity.Property(e => e.CveUsoCFDI).HasColumnName("cveUsoCfdi");
                entity.Property(e => e.CveMetodoPago).HasColumnName("cveMetodoPago");
                ...
                entity.HasOne(d => d.FormaPago)
                    .WithMany(p => p.Ventas)
                    .HasForeignKey(d => d.CveFormaPago)
                    .HasConstraintName("FK_Venta_FormaPago");

                entity.HasOne(d => d.UsoCFDI)
                    .WithMany(p => p.Ventas)
                    .HasForeignKey(d => d.CveUsoCFDI)
                    .HasConstraintName("FK_Venta_UsoCfdi");
            });
